...
class TreePrinter {
    ...
    private static <T extends Comparable<?>> void printNodeInternal(List<TreapNode> nodes, int level, int maxLevel) {
    ...
    private static <T extends Comparable<?>> int maxLevel(TreapNode node) {
        if (node == null)
            return 0;
